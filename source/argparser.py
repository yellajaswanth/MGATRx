...
def parse_args():
    ...
    parser.add_argument('--epochs',
                        type=int,
                        default=2000,
                        help='Number of epochs to train. Default is 2000.')
    ...
    parser.add_argument('--embed-size',
                        type=int,
                        default=512,
                        help='Embedding size of each view. Default is 512.')
    ...
    parser.add_argument('--save-model',
                        action='store_true',
                        default=False,
                        help='Save model for each fold to `tmp/`. Default is False.')

    parser.add_argument('--fold-test',
                        action='store_true',
                        default=False,
                        help='Run only the first fold (debug mode). Default is False.')
    ...
    parser.add_argument('--encoder',
                        ...
                        default='GAT',
                        choices=['GCN', 'GAT'],
                        help='Choose encoder type. Default is `GAT`.')
    ...
    parser.add_argument('--seed',
                        type=int,
                        default=1,
                        help='Random seed for consistency. Default is 1.')
